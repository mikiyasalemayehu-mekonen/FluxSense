...
class SentinelService:
    """
    Models are cached as class attributes so they load once
    and stay in memory across requests without reloading.
    Module-level instantiation removed to prevent OOM at startup.
    """
